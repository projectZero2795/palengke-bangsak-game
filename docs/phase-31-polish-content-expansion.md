...
| 34F | Android performance | Reference-profile FPS/frame time, memory, and size budgets only; thermal was removed by the owner. | One measured round meets the recorded budgets. |
