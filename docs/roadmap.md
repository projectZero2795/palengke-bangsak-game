...
| 34B | Android debug build | Add a reproducible Unity Android debug-APK build without signing or store work. | Ready for review: `0.34.0` installs and opens the main menu on the Pixel 6 Android 15 reference emulator; 213 tests pass. |
