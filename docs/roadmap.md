...
| 34A | Android release decisions | Lock the package ID, minimum Android version, orientation, reference device, Play Console account type, and privacy/support contacts. | Ready for review; decisions are recorded from the project and signed-in Play Console. No build was made. |
